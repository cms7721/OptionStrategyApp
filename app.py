...
descriptions = {
    ...
    'Long Straddle':"A non-directional, two legged strategy made by buying a call and a put an the same strike price. Profits when there is significant price movement. Unlimited risk with limited potential profit. Net debit.",
    'Short Straddle':"A non-directional, two legged strategy made by selling a call and a put at the same strike price. Profits when there is little price movement. Limited risk with unlimited potential profit. Net credit.",
    'Long Strangle':"A non-directional, two legged strategy made by buying a calls and a put. Profits when there is significant price movement. Limited risk with limited potential profit. Net debit.",
    'Short Strangle':"A non-directional, two legged strategy made by selling a call and a put. Profits when there is little price movement. Limited risk with limited potential profit. Net credit.",
